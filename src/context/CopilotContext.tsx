...
interface CopilotContextType {
  ...
  handleSuggestionAction: (id: string, action: SuggestionStatus, feedback?: string) => void;
}
...
export function CopilotProvider({ children }: { children: ReactNode }) {
  ...
  const handleSuggestionAction = (id: string, action: SuggestionStatus, feedback?: string) => {
  ...
  return (
    <CopilotContext.Provider value={{ currentView, setCurrentView, skus, suggestions, handleSuggestionAction }}>
      {children}
